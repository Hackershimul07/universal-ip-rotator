# 👑 SHIMUL Universal IP Rotator & VPN Gateway Bot (v3.0 Pro)
...
1. **Installation License Password** (Default: `SHIMUL_VIP_2026`)
...
systemctl status shimul-ip-rotator

# Restart bot
systemctl restart shimul-ip-rotator

# View live logs
journalctl -u shimul-ip-rotator -f
```
...
**SHIMUL** — Universal Network Routing & Proxy Automation Engine.
